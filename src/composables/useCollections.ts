...
type CollectionType = "recommendations" | "top" | "season" | "search";
  ...
  const fetchCollections = async (
    ...
    switch (type) {
      ...
      case "search":
        ...
        url = `https://api.jikan.moe/v4/anime?order_by=popularity&sort=desc&q=${
          obj.currentQuery
        }&page=${obj.page}${obj.param ? obj.param : ""}&sfw=${
          safetySearch.value
        }`;
        break;
    }
